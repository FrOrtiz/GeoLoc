...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ruta = getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS) + "/localizaciones.db4o";
        Toast.makeText(this, ruta, Toast.LENGTH_LONG).show();

        serviceTracking = new Intent(this, LocationService.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationManager.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 60000, 25, this);
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 60000, 25, this);
    ...
    public void loadRoute(){
        Thread hilo = new Thread(){
            ...
            public void run() {
                super.run();
                DB4o db4o = new DB4o();
                ArrayList<Localizacion> result = db4o.getLocationByDate(getIntent().getStringExtra("fecha"),ruta);
                for(Localizacion value : result){
